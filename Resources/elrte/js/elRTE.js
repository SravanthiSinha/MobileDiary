...
(function ($) {
    ...
    elRTE = function (target, opts) {
        ...
        this.statusbar = $('<div class="statusbar"/>').hide();
        this.tabsbar = $('<div class="tabsbar"/>');
        this.editor = $('<div class="' + this.options.cssClass + '" />').append(this.toolbar).append(this.workzone).append(this.statusbar);
    ...
    **/
    elRTE.prototype.save = function () {
        ...
        $.ajax({
            url: '/api/Note',
            data: { note: $("textarea").val(), journalId: $("#userjournals option:selected").val() },
